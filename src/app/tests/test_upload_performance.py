...
class TestUploadParalelismo:
    ...
    def test_upload_5_documentos_simultaneos(self):
        ...
        files = [
            (
                'arquivos',
                (
                    BytesIO(f'Conteúdo do documento {i}'.encode()),
                    f'doc{i}.pdf',
                ),
            )
            for i in range(5)
        ]
        data = {'tipos_doc': [f'tipo_{i}' for i in range(5)]}
    ...
    def test_upload_10_documentos(self):
        ...
        data = {'tipos_doc': [f'tipo_{i}' for i in range(10)]}
...
class TestUploadFileDetails:
    ...
    def test_retorna_detalhes_cada_documento(self):
        ...
        data = {'tipos_doc': ['cpf', 'rg', 'comprovante']}
...
class TestUploadMemoryUsage:
    ...
    def test_upload_arquivo_grande(self):
        ...
        data = {'tipos_doc': ['documento_grande']}
    ...
    def test_rejeita_arquivo_muito_grande(self):
        ...
        data = {'tipos_doc': ['documento_enorme']}
        ...
        for batch_num in range(3):
            ...
            files = [
                (
                    'arquivos',
                    (
                        BytesIO(f'Batch {batch_num}, Doc {i}'.encode()),
                        f'doc{i}.pdf',
                    ),
                )
                for i in range(3)
            ]
            data = {'tipos_doc': [f'doc_{i}' for i in range(3)]}
